    ...
    <div className="min-h-screen">
      ...
      <div className="mb-12">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className={`${poppins.className} text-5xl md:text-6xl font-bold text-white mb-3 tracking-tight`}>
              Notícias do Timão
            </h1>
      ...
      {isLoadingHighlights ? (
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className={`${poppins.className} text-2xl font-semibold text-white tracking-normal`}>Destaques do Dia</h2>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-sm border border-white/10 rounded-2xl p-6 h-full transition-all duration-300 group-hover:border-yellow-500/50">
                    ...
                    {/* Title */}
                    <h3 className={`${poppins.className} text-xl sm:text-2xl font-semibold text-white mb-2 line-clamp-2 group-hover:text-yellow-500 transition-colors leading-snug tracking-normal`}>
                      {item.title}
                    </h3>
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-thin">
          {NEWS_CATEGORIES.map((category) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-base font-semibold whitespace-nowrap transition-all ${
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-thin">
          {PERIODS.map((period) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-semibold whitespace-nowrap text-base transition-all ${
      ...
      <div>
        ...
        {isLoadingNews ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className={`${poppins.className} text-2xl text-white mb-2 font-semibold tracking-normal`}>Nenhuma notícia encontrada</h3>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2.5 py-1 rounded bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 text-xs sm:text-sm font-semibold">
                            {getCategoryIcon(item.category)} {item.category}
                          </span>
                        ...
                        {/* Title */}
                        <h3 className={`${poppins.className} text-lg sm:text-xl font-semibold text-white mb-1.5 line-clamp-2 group-hover:text-yellow-500 transition-colors tracking-normal leading-snug`}>
                          {item.title}
                        </h3>

                        {/* Summary */}
                        <p className="text-gray-300 text-sm sm:text-base line-clamp-2 mb-2 leading-relaxed">
                          {item.summary}
                        </p>
