      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-6 rounded-xl">
            <p className="font-bold mb-2">Link inválido</p>
            <p className="text-sm">Este link não é válido. Solicite um novo na página de recuperação.</p>
          </div>
          <Link href="/auth/forgot-password" className="text-sm text-gray-400 hover:text-white mt-4 inline-block">
            Solicitar novo link
          </Link>
        </div>
      </div>
